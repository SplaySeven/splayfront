                ...
                <DivHeader2>
                    <Row>
                        <Colmd12>
                            ...
                            <DivInputsearch>
                                <Inputsearch onChange={(e) => handleChange(e.target.value)} onKeyDown={(e)=> handleKeyDown(e)}/>                            
                                <SearchIcon/>
                            </DivInputsearch>
                        </Colmd12>
                    </Row>
                ...
                <Row>
                    <Colmd3A>
                        <DivoptA>
                            ...
                            <DivoptA3>
                                <DivIconPostOnbig><IconPostOnbig/></DivIconPostOnbig> <DivoptA3text>Publicaciones</DivoptA3text> <DivoptA3check><Checkfilter/></DivoptA3check>
                            </DivoptA3>
                            <DivoptA3>
                                <DivIconPostOnbig><IconPhotovideoOnBig/></DivIconPostOnbig> <DivoptA3text>Fotos</DivoptA3text> <DivoptA3check><Checkfilter/></DivoptA3check>
                            </DivoptA3>
                            
                            <DivoptA3>
                                <DivIconPostOnbig><IconLiveOnBig/></DivIconPostOnbig> <DivoptA3text>Videos</DivoptA3text> <DivoptA3check><Checkfilter/></DivoptA3check>
                            </DivoptA3>
                            <DivoptA3>
                                <DivIconPostOnbig><IconPlaceOnBig/></DivIconPostOnbig> <DivoptA3text2>Lugares <br/>Acontecimientos</DivoptA3text2> <DivoptA3check><Checkfilter/></DivoptA3check>
                            </DivoptA3>
                            <DivoptA4>
                        ...
                        <DivoptB>
                            ...
                            <Divseemore>
                                <DivoptA1Icon><IconMoreOn/></DivoptA1Icon> <DivoptA1Text>Todos mis Amigos <br/>ONLINE</DivoptA1Text>
                            </Divseemore>
                        </DivoptB>
                        <DivoptA>
                            <Divpeoplemayknow>
                            ...
                            <Divseemore>
                                <DivoptA1Icon><IconMoreOn/></DivoptA1Icon><FriendName2>Más Personas</FriendName2>
                            </Divseemore>
                    ...
                    <Colmd9A>
                        ...
                        <Colmd9Aa>
                            ...
                            <Headerpost>
                                <Row>
                                    <HpostphotoCol1>
                                        ...
                                        <HpostphotoCol1Name>Miguel Cruz
                                        </HpostphotoCol1Name>
                                    </HpostphotoCol1>
                                    <HpostphotoCol2>
                                        Julio 25 2020
                            ...
                            <Bodypostphoto>
                                <Imgpost src="/imagenes/post1.jpg"></Imgpost>
                            </Bodypostphoto>
                            <Footerpost>
                                <Row>
                                    <DivLike>
                        ...
                        <Postvideo>
                            ...
                            <Bodypostvideo>
                                ...
                                <Imgpost src="/imagenes/post2.jpg"></Imgpost>
                            </Bodypostvideo>
                            <Footerpost>
                                <Row>
                                    <DivLike>
...
const Bodypostvideo = styled.div`
position: relative;
`
